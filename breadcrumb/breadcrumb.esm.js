                ...
                ? (openBlock(), createBlock(_component_router_link, {
                    ...
                    default: withCtx(({navigate, href, isActive, isExactActive}) => [
                      createElementVNode("a", {
                        ...
                        ($props.item.label)
                          ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString($options.label()), 1))
                          : createCommentVNode("", true)
                      ], 10, _hoisted_1)
                    ]),
                    _: 1
...
const _hoisted_2$1 = /*#__PURE__*/createElementVNode("li", { class: "p-breadcrumb-chevron pi pi-chevron-right" }, null, -1);
