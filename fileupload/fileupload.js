...
this.primevue.fileupload = (function (Button, ProgressBar, Message, utils, Ripple, vue) {
    ...
    ProgressBar = ProgressBar && ProgressBar.hasOwnProperty('default') ? ProgressBar['default'] : ProgressBar;
    Message = Message && Message.hasOwnProperty('default') ? Message['default'] : Message;
