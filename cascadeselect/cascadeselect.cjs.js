      ...
      return (vue.openBlock(), vue.createElementBlock("li", {
        ...
        vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
          ...
          ($props.templates['option'])
            ...
            : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString($options.getOptionLabelToRender(option)), 1)),
...
const _hoisted_2$1 = ["id", "disabled", "tabindex", "aria-expanded", "aria-labelledby"];
const _hoisted_3$1 = ["aria-expanded"];
const _hoisted_4$1 = { class: "p-cascadeselect-items-wrapper" };
