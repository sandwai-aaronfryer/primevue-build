...
const _hoisted_2 = { class: "p-hidden-accessible" };
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("td", {
    ...
    ($props.column.children && $props.column.children.body)
      ...
      : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3, vue.toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp('field'))), 1))
  ], 6))
}
