...
const _hoisted_3 = /*#__PURE__*/createElementVNode("span", { class: "pi pi-filter-icon pi-filter" }, null, -1);
const _hoisted_4 = [
  _hoisted_3
];
const _hoisted_5 = /*#__PURE__*/createElementVNode("span", { class: "pi pi-filter-slash" }, null, -1);
const _hoisted_6 = [
  _hoisted_5
];
const _hoisted_7 = {
  ...
  return (openBlock(), createElementBlock("th", {
    ...
    createElementVNode("div", _hoisted_2$1, [
      ...
      ($options.columnProp('header'))
        ? (openBlock(), createElementBlock("span", _hoisted_3$1, toDisplayString($options.columnProp('header')), 1))
        : createCommentVNode("", true),
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("thead", _hoisted_1$3, [
    (!$props.columnGroup)
      ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          ...
          ($props.filterDisplay === 'row')
            ? (openBlock(), createElementBlock("tr", _hoisted_3$2, [
                (openBlock(true), createElementBlock(Fragment, null, renderList($props.columns, (col, i) => {
                  return (openBlock(), createElementBlock(Fragment, {
                    key: $options.columnProp(col, 'columnKey')||$options.columnProp(col, 'field')||i
                  }, [
...
const _hoisted_2$3 = /*#__PURE__*/createElementVNode("div", { class: "p-radiobutton-icon" }, null, -1);
const _hoisted_3$3 = [
  _hoisted_2$3
];
...
const _hoisted_2$4 = /*#__PURE__*/createElementVNode("span", { class: "p-row-editor-init-icon pi pi-fw pi-pencil" }, null, -1);
const _hoisted_3$4 = [
  _hoisted_2$4
];
...
const _hoisted_6$1 = /*#__PURE__*/createElementVNode("span", { class: "p-row-editor-cancel-icon pi pi-fw pi-times" }, null, -1);
const _hoisted_7$1 = [
  _hoisted_6$1
];
  ...
  return ($options.loading)
    ...
    : (openBlock(), createElementBlock("td", {
        ...
        ($props.responsiveLayout === 'stack')
          ? (openBlock(), createElementBlock("span", _hoisted_1$6, toDisplayString($options.columnProp('header')), 1))
          : createCommentVNode("", true),
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ($options.hasFooter)
    ? (openBlock(), createElementBlock("tfoot", _hoisted_1$9, [
        (!$props.columnGroup)
          ? (openBlock(), createElementBlock("tr", _hoisted_2$6, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($props.columns, (col, i) => {
                return (openBlock(), createElementBlock(Fragment, {
                  key: $options.columnProp(col,'columnKey')||$options.columnProp(col,'field')||i
                }, [
    ...
    methods: {
        ...
        updateSelectionKeys(selection) {
            ...
            if (Array.isArray(selection)) {
                ...
                this.d_selectionKeys[
                    String(
                        ObjectUtils.resolveFieldData(selection, this.dataKey)
                    )
                ] = 1;
            }
        },
...
`;
    ...
    computed: {
        ...
        virtualScrollerDisabled() {
            return (
                ObjectUtils.isEmpty(this.virtualScrollerOptions) ||
                !this.scrollable
            );
        },
    },
...
function render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    (_ctx.$slots.footer)
      ...
      : createCommentVNode("", true),
    createElementVNode("div", _hoisted_4$4, null, 512),
    ($props.reorderableColumns)
      ? (openBlock(), createElementBlock("span", _hoisted_5$3, null, 512))
      : createCommentVNode("", true),
    ($props.reorderableColumns)
      ? (openBlock(), createElementBlock("span", _hoisted_6$3, null, 512))
      : createCommentVNode("", true)
  ], 2))
}
