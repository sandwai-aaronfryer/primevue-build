...
this.primevue.datatable = (function (utils, api, Paginator, VirtualScroller, vue, OverlayEventBus, Dropdown, Button, Portal, Ripple) {
    ...
    VirtualScroller = VirtualScroller && VirtualScroller.hasOwnProperty('default') ? VirtualScroller['default'] : VirtualScroller;
    OverlayEventBus = OverlayEventBus && OverlayEventBus.hasOwnProperty('default') ? OverlayEventBus['default'] : OverlayEventBus;
