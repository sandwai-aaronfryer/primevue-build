...
const _hoisted_2 = ["href", "onClick", "aria-expanded"];
const _hoisted_3 = { class: "p-menuitem-text" };
const _hoisted_4 = ["href", "target", "onClick", "onKeydown", "aria-expanded", "tabindex"];
const _hoisted_5 = { class: "p-menuitem-text" };
const _hoisted_6 = { class: "p-toggleable-content" };
...
const _hoisted_4$1 = ["href", "onClick", "onKeydown", "tabindex", "aria-expanded", "id", "aria-controls"];
const _hoisted_5$1 = { class: "p-menuitem-text" };
const _hoisted_6$1 = ["id", "aria-labelledby"];
const _hoisted_7 = {
  key: 0,
